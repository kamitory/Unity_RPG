...
function Start(){
		...
		originalInset.x = guiTexture.pixelInset.x;
		originalInset.y = guiTexture.pixelInset.y;
		
		//Reset GUI Pixel Inset to original position
		guiTexture.pixelInset.x = originalInset.x;
		guiTexture.pixelInset.y = originalInset.y;
